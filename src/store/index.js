...
export default {
  ...
  actions: {
    ...
    login(email, password) {
      api.post('https://keeprclone.herokuapp.com/login', {
        email: email,
        password: password
      })
        .then(res => {
    ...
    register(name, email, password) {
      api.post('https://keeprclone.herokuapp.com/register', {
        name: name,
        email: email,
        password: password
      })
    ...
    logout() {
      api.delete('https://keeprclone.herokuapp.com/logout')
        .then(res => {
          state.user = {};
    ...
    authenticate() {
      api('https://keeprclone.herokuapp.com/authenticate')
        .then(res => {
          if (res.data.data) {
            state.user = res.data.data;
            this.getUserKeeps();
